...
from misc.coco import Coco, CocoAnnotation, CocoImage, create_coco_dict
from misc.cv import read_image_as_pil
...
def slice_image(
    ...
    for slice_bbox in slice_bboxes:
        ...
        coco_image = CocoImage(file_name=slice_file_name,
                               height=slice_height, width=slice_width)
        ...
        sliced_image = SlicedImage(
            image=image_pil_slice, coco_image=coco_image, starting_pixel=[
    ...
    verboselog(
        "Num slices: " + str(n_ims) + " slice_height: " +
...
def slice_coco(
    ...
    if output_coco_annotation_file_name and output_dir:
        save_path = Path(output_dir) / \
            (output_coco_annotation_file_name + "_coco.json")
